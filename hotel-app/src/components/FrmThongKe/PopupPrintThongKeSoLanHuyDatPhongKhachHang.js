...
const PopupPrintThongKeSoLanHuyDatPhongKhachHang = (props) => {

    const { setOpenPopupPrintSoLanKhachHangHuyDatPhong, openPopupPrintSoLanKhachHangHuyDatPhong, dsThongKeSoLanHuyDatPhongCuaKhachHang, search } = props;
    ...
    return (
        <Dialog open={openPopupPrintSoLanKhachHangHuyDatPhong} fullScreen>
            <DialogTitle>
                <Stack flexDirection='row' justifyContent='space-between'>
                    ...
                    <IconButton color="inherit" aria-label="close" onClick={() => {
                        setOpenPopupPrintSoLanKhachHangHuyDatPhong(false)
            ...
            <DialogContent dividers>
                <Box ref={componentRef}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: '10px' }}>
                        <Typography variant='h4' color='dodgerblue'>Báo cáo số lần hủy đặt phòng của khách hàng</Typography>
                    </Box>
                    <Stack flexDirection='row' justifyContent='space-between'  >
                    ...
                    {dsThongKeSoLanHuyDatPhongCuaKhachHang && dsThongKeSoLanHuyDatPhongCuaKhachHang.length > 0 &&
...
export default PopupPrintThongKeSoLanHuyDatPhongKhachHang
