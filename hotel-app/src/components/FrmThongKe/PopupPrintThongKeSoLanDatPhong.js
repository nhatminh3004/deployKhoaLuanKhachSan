...
const PopupPrintThongKeSoLanDatPhong = (props) => {

    const { setOpenPopupPrintSoLanDatPhong, openPopupPrintSoLanDatPhong, dsThongKeSoLanDatPhong, search } = props;
    ...
    return (
        <Dialog open={openPopupPrintSoLanDatPhong} fullScreen>
            <DialogTitle>
                <Stack flexDirection='row' justifyContent='space-between'>
                    ...
                    <IconButton color="inherit" aria-label="close" onClick={() => {
                        setOpenPopupPrintSoLanDatPhong(false)
            ...
            <DialogContent dividers>
                <Box ref={componentRef}>
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'center', mt: '10px' }}>
                        <Typography variant='h4' color='dodgerblue'>Báo cáo số lần đặt phòng theo từng phòng</Typography>
                    </Box>
                    <Stack flexDirection='row' justifyContent='space-between'  >
...
export default PopupPrintThongKeSoLanDatPhong
